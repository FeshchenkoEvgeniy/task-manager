...
import { changeBoardColumns } from 'redux/board/slice';
import { Wrapper, Header, ColumnList, BoardTitle } from './ScreenPage.styled';
import { editBoardCardOwner } from 'redux/board/operations';

function ScreenPageComponent() {
  ...
  const onDragEnd = result => {
    ...
    dispatch(changeBoardColumns(boardCopy.columns));
  };
...
export default ScreenPageComponent;
